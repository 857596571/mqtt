...
public class PubMsg {
    ...
    private static String broker = "tcp://0.0.0.0:61613";
...
//		connOpts.setServerURIs(uris);  //起到负载均衡和高可用的作用
        ...
        mqttClient.setCallback(new InPushCallback("test"));
...
class InPushCallback implements MqttCallback {
    private String threadId;
    public InPushCallback(String threadId){
